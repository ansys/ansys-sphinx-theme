...
latex_documents = [
    (master_doc, 'pyansys.tex', 'pyansys_sphinx_theme Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pyansys_sphinx_theme', 'pyansys_sphinx_theme Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyansys_sphinx_theme', 'pyansys_sphinx_theme Documentation',
     author, 'pyansys_sphinx_theme', 'PyAnsys themed sphinx documentation',

// Webpack configuration for pyansys-sphinx-theme.
// This file was copied from pydata-sphinx-theme.
//
...
const staticPath = resolve(
  __dirname,
  "src/pyansys_sphinx_theme/theme/pyansys_sphinx_theme/static"
);
...
function macroTemplate({ compilation }) {
  ...
  const css_files = ["styles/theme.css", "styles/pyansys-sphinx-theme.css"];
  const js_files = ["scripts/pyansys-sphinx-theme.js"];
...
module.exports = {
  ...
  entry: {
    "pyansys-sphinx-theme": [
      "./src/pyansys_sphinx_theme/assets/scripts/index.js",
    ],
  },
  output: {
        ...
        use: [
          {
            loader: "file-loader",
            options: {
              name: "styles/pyansys-sphinx-theme.css",
            },
          },
          {
